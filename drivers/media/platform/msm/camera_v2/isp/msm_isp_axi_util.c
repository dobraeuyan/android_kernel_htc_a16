...
//HTC_START, fix klocwork. 'stream_info' might be used uninitialized in this function.
#if 0
	frame_id = vfe_dev->axi_data.
		src_info[SRC_TO_INTF(stream_info->stream_src)].frame_id;
#endif
...
//HTC_START, fix klocwork. move 'stream_info' to here after initialized.
				frame_id = vfe_dev->axi_data.src_info[SRC_TO_INTF(stream_info->stream_src)].frame_id;
//HTC_END
